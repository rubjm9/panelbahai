      ...
      <div className="min-h-screen bg-white">
        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-r from-bahai-lightgray to-white p-8 text-center">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <section>
              ...
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-bahai-gold hover:bg-bahai-darkgold text-white font-medium py-3 px-6 transition-colors duration-200 flex items-center justify-center"
                >
            ...
            <section>
              ...
              <div className="space-y-6">
                <div className="bg-bahai-lightgray p-6">
                  <div className="flex items-start">
              ...
              <div className="mt-8">
                ...
                <div className="space-y-3">
                  <div className="flex items-center">
                    <div className="w-2 h-2 bg-bahai-gold mr-3"></div>
