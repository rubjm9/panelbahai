...
export default async function AdminImportPage() {
  try {
    ...
    console.error('Error loading importar page:', error);
    return (
      <div className="admin-content">
        <div className="text-center py-16">
          ...
          <h3 className="text-xl font-medium text-primary-800 mb-2">
            Error al cargar página de importación
          </h3>
          <p className="text-primary-500 mb-6">
            Ha ocurrido un error al cargar la página de importación. Por favor, intenta de nuevo más tarde.
          </p>
          <button 
