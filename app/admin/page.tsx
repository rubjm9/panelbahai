      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-8">
        {stats.map((item) => {
          ...
          return (
            ...
            >
              <dt>
                <div className="absolute bg-bahai-gold p-3">
                  <Icon className="h-6 w-6 text-white" />
                </div>
                <p className="ml-16 text-sm font-medium text-primary-500 truncate">
                  {item.name}
                </p>
              </dt>
              <dd className="ml-16 pb-6 flex items-baseline sm:pb-7">
                ...
                <p className={`ml-2 flex items-baseline text-sm font-semibold ${
                  ...
                  item.changeType === 'negative' ? 'text-red-600' : 'text-primary-500'
                }`}>
                  {item.change}
                </p>
              </dd>
                  ...
                  <li key={activity.id}>
                    <div className="relative pb-8">
                      ...
                      <div className="relative flex space-x-3">
                        <div>
                          <span className="h-8 w-8 bg-bahai-gold flex items-center justify-center ring-8 ring-white">
        ...
        <div className="bg-white shadow">
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="space-y-4">
              <button className="w-full bg-bahai-gold hover:bg-bahai-darkgold text-white font-medium py-3 px-4 transition-colors flex items-center justify-center">
                <BookOpen className="w-5 h-5 mr-2" />
                Agregar Nueva Obra
              </button>
              <button className="w-full bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium py-3 px-4 transition-colors flex items-center justify-center">
