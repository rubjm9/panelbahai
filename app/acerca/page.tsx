      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="bg-primary-900 text-white">
          <div className="container-elegant">
            <div className="section-elegant text-center">
              <h1 className="display-title text-white mb-4">Acerca del Panel</h1>
              <p className="text-xl text-primary-200 max-w-3xl mx-auto">Panel de Traducción de Literatura Bahá'í al Español</p>
            </div>
          </div>
        </section>
        {/* Breadcrumbs */}
        <nav className="header-elegant">
          <div className="container-elegant">
            <div className="flex items-center py-4">
              ...
              <span className="text-primary-900 font-medium">Acerca del Panel</span>
            </div>
          </div>
        </nav>
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <section className="mb-16">
            <div className="bg-gradient-to-r from-bahai-lightgray to-white p-8">
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-16 h-16 bg-bahai-gold flex items-center justify-center mx-auto mb-4">
          ...
          <section className="mb-16">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="bg-bahai-gold text-white w-8 h-8 flex items-center justify-center font-bold mr-4 mt-1">
                  1
                </div>
                <div>
          ...
          {/* Contacto */}
          <section className="bg-bahai-navy text-white p-8 text-center">
            ...
            <Link href="/contacto" className="bg-bahai-gold hover:bg-bahai-darkgold text-white font-medium py-3 px-6 transition-colors duration-200 inline-block">
              Contáctanos
            </Link>
          </section>
        </main>
