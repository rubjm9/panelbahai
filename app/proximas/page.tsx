      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="bg-primary-900 text-white">
          <div className="container-elegant">
            <div className="section-elegant text-center">
              ...
              <p className="text-xl text-primary-200 max-w-3xl mx-auto">Proyectos en desarrollo y planificación</p>
            </div>
          </div>
        </section>
        {/* Breadcrumbs */}
        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div key={index} className="bg-white border border-gray-200 p-6 hover:shadow-md transition-shadow">
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-4">
                    ...
                    <div className="mt-4 lg:mt-0 lg:ml-6 flex-shrink-0">
                      <span className={`inline-flex items-center px-3 py-1 text-sm font-medium ${getEstadoColor(obra.estado)}`}>
                        {obra.estado}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <div className="w-full bg-gray-200 h-2">
                        <div 
                          className="bg-bahai-gold h-2 transition-all duration-300"
          ...
          <section className="bg-bahai-navy text-white p-8 text-center">
            ...
            <Link 
              href="/contacto" 
              className="bg-bahai-gold hover:bg-bahai-darkgold text-white font-medium py-3 px-6 transition-colors duration-200 inline-block"
            >
              Contáctanos
            </Link>
          </section>
